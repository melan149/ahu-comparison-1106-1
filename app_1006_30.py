...
with col_filter1:
    ...
    if selected_recovery1 == "RRG" and type_col:
        ...
        selected_type1 = st.selectbox("Rotary wheel type", available_types1, key="type1")
        ...
        selected_material1 = st.selectbox("PCR/HEX lamels material", available_materials1, key="material1")
...
with col_filter2:
    ...
    if selected_recovery2 == "RRG" and type_col:
        ...
        selected_type2 = st.selectbox("Rotary wheel type", available_types2, key="type2")
        ...
        selected_material2 = st.selectbox("PCR/HEX lamels material", available_materials2, key="material2")
