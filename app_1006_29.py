...
with col_filter1:
    ...
    # --- Brand Logo Path (used later for display) ---
    ...
    # --- Unit Photo Path (used later for display) ---
    unit_photo_path1 = df_filtered_by_unit1[unit_photo_col].values[0] if not df_filtered_by_unit1.empty and unit_photo_col and unit_photo_col in df_filtered_by_unit1.columns else None
...
with col_filter2:
    ...
    # --- Unit Photo Path (used later for display) ---
    unit_photo_path2 = df_filtered_by_unit2[unit_photo_col].values[0] if not df_filtered_by_unit2.empty and unit_photo_col and unit_photo_col in df_filtered_by_unit2.columns else None
